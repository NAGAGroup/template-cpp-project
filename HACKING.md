...
hidden if the `template-cpp-project_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `template-cpp-project_DEVELOPER_MODE` to the configure
